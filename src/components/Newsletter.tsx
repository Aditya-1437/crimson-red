    ...
    <section className="bg-white py-24 md:py-32">
      <div className="container mx-auto px-4 md:px-8">
        <motion.div
           ...
           className="bg-crimson rounded-[2.5rem] md:rounded-[4rem] px-6 py-12 md:px-8 md:py-20 lg:py-32 shadow-[0_30px_60px_rgb(153,0,0,0.2)] text-center max-w-6xl mx-auto relative overflow-hidden"
        >
           ...
           <div className="relative z-10 max-w-3xl mx-auto">
             <h2 className="font-serif text-4xl sm:text-5xl md:text-7xl text-white font-bold mb-6 md:mb-8">
               Join the Inner Circle
             </h2>
             <p className="text-white/90 text-lg sm:text-xl md:text-2xl mb-10 md:mb-12 max-w-2xl mx-auto font-light leading-relaxed px-4 md:px-0">
